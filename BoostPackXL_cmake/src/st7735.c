...
void Test_Graphics()
{
  ...
  //   buffer[i] = 0xA000;
  // }
  // BSP_LCD_Flush(0,0,ST7735_TFTWIDTH-1,ST7735_TFTHEIGHT-1,buffer,ST7735_TFTWIDTH*ST7735_TFTHEIGHT);
  // BSP_Delay_ms(5000);
