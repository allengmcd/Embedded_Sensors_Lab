...
uint8_t writebuffer16(uint16_t *buffer, uint32_t length) {
  TFT_CS_SET(TFT_CS_LOW);
  DC_SET(DC_DATA);
...
uint32_t BSP_ST7735_ColorTranslate(void *pvDisplayData __attribute((unused)), uint32_t ui32Value __attribute((unused)))
{
